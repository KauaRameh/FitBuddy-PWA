const menuTreino = document.createElement('template');

menuTreino.innerHTML = `
<style>
  ...
  <nav class="container-fluid fixed-bottom mb-n2 pt-3 pb-2 border-top border-black" style="background-color: #FFFFFF;">
    ...
    <div class="row justify-content-around text-center">
        ...
        <div onclick="location.href='/src/pages/treino/treino.html';"class="col-3">
            <div class="text-primary">
                <i class="fa-solid fa-dumbbell" style   ="font-size: 1.6rem; color: #FF650F;"></i>
                <p style="font-size: small; font-weight: 600; color: #FF650F;" >Treino</p>
            </div>
        </div>
        ...
        <div onclick="location.href='/src/pages/perfil/perfil.html';" style="cursor: pointer;" class="col-3">
            <div class="text-primary">
                <i class="fa-solid fa-user" style="font-size: 1.6rem; color: #8F8F8F;"></i>
                <p style="font-size: small; font-weight: 600; color: #8F8F8F;" >Perfil</p>
            </div>
        </div>
...
class Menu extends HTMLElement {
  ...
  connectedCallback() {
    ...
    shadowRoot.appendChild(menuTreino.content);
  }
}
